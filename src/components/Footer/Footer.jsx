...
export default function Footer() {
    return (
        <footer className="bg-white border-top py-6">
            <div className="container">
                    ...
                    <div className="col-md-3 mb-4 mb-md-0">
                        <Link to="/" className="d-flex align-items-center">
                            <img
                                ...
                                className="mr-3"
                                alt="Logo"
                                style={{ height: '64px' }} // Adjust as needed
                            />
                        </Link>
                    </div>
                    <div className="col-md-9">
                        {/* columns in  grid system - size designation indicating that the column will apply to medium sized screens and larger -the number of columns the element should span */}
                        <div className="row">
                ...
                <div className="row">
                    <div className="col-md-6 text-muted">
                        © 2023{' '}
                        <a href="https://hiteshchoudhary.com/" className="text-muted">
                            sachmansingh
                        </a>
                        . All Rights Reserved.
                    </div>
